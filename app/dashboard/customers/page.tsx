  ...
  return (
    <div className="p-4 md:p-6 lg:p-8">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6 md:mb-8">
        ...
        <button
          onClick={load}
          className="flex items-center justify-center gap-2 text-sm text-slate-500 hover:text-slate-700 px-3 py-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 transition shadow-sm w-full sm:w-auto flex-shrink-0"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 md:mb-8">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 sm:p-5 min-w-0">
          ...
          <p className="text-xl sm:text-2xl font-bold text-slate-900">{optInCount}</p>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 sm:p-5 min-w-0">
          ...
          <p className="text-xl sm:text-2xl font-bold text-slate-900">{optInRate}%</p>
