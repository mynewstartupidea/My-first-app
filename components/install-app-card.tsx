...
//   when its own criteria are met; a click on our button calls .prompt() on
//   that captured event — one tap, native install dialog, done.
...
//   "Add to Home Screen" programmatically. This is a hard platform
//   restriction, not a gap here — every installable web app hits it. The
//   only thing to do is show the manual steps.
...
export default function InstallAppCard() {
  ...
  // No beforeinstallprompt (yet, or unsupported browser) and not iOS — nothing
  // reliable to show rather than instructions that might not apply here.
  return null
}
